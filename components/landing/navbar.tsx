      ...
      <div className="container mx-auto px-4">
        <div className="h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/new%20logo.png" alt="BatchPay logo" className="h-8 w-8 object-contain" />
            <div className="hidden sm:block font-semibold text-white">Stellar BatchPay</div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/demo">
              <Button size="sm" className="bg-[#00D98B] text-black hover:bg-[#00c777]">Launch App</Button>
            </Link>
